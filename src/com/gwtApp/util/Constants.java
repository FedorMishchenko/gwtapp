...
public final class Constants {
    public static final String INPUT_REGEX = "\\b([1-9]{1}\\d{0,2}|[1]{1}[0]{3})\\b";
    ...
    public static final String INVALID_DATA_MASSAGE = "The input must be a number in the range from 1 to 1000";
